                        ...
                        <div class="item active">
                            <div class="single-item">
                                <div class="img-holder">
                                    <img src="{{asset('public/front/img')}}/project/project-single.jpg" alt="Awesome Image">
                                </div>
                            </div>
                        </div>
                        <div class="item">
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="content">
                    <div class="sec-title-two">
                        <h2>Cateridge Bearing Manufacturing</h2>
            ...
            <div class="col-md-3">
                <div class="single-project-info">
                    <ul>
                        <li><span>Category :</span>Material Engineering</li>
        ...
        <div class="row bottom">
            <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="button prev pull-left">
                    <a href="#"><i class="fa fa-chevron-left" aria-hidden="true"></i>Prev</a>    
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-4">
