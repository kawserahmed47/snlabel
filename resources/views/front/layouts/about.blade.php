...
<section class="about-us-area">
    <div class="outer-box clearfix">
        <div class="image-column" style="background-image:url({{asset('public/front/img')}}/about/bg-image.jpg);">
        ...
        <div class="content-column tab-content">
            ...
            <div class="inner-box tab-pane fade in active" id="about">
                ...
                <div class="text-box">
                    <p>Over 24 years experience and knowledge international standards, technologicaly changes and industrial systems, we are dedicated to provides seds the best solutions to our valued customers there us are many variations of of Lorem Ipsum available, but the passages majority have suffered.</p>
                </div>
                <div class="fact-counter">
                    <ul>
                        ...
                        <li class="single-fact-counter">
                            <div class="icon-holder"><span class="flaticon-buildings"></span></div>
                            ...
                            <div class="single-item">
                                ...
                                <div class="img-text-holder">
                                    <div class="img-holder">
                                        <img src="{{asset('public/front/img')}}/about/tab/1.jpg" alt="Awesome Image">
                                    </div>
                                    <div class="text-holder">
                                        <h3>Started at Newyork City</h3>
                                        <p>Explain to you how all this mistaken idea of our was born and I will give you a complete.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="single-item">
                                ...
                                <div class="img-text-holder">
                                    <div class="img-holder">
                                        <img src="{{asset('public/front/img')}}/about/tab/2.jpg" alt="Awesome Image">
                                    </div>
                                    <div class="text-holder">
                                        <h3>First recognition</h3>
                                        <p>Who loves or pursues or desires to obtain pain of itselfit sed is pain circumstances.</p>
                                    </div>
                                </div>
                            </div>
                        </li>
            ...
            <div class="inner-box tab-pane fade active" id="process">
                ...
                <div class="text-box">
                    <p>Knowledge international standards of, technologicaly changes industrial systems we are dedicated to provides seds the best and economical solutions to valued customers there us are many variations of majority have suffered.</p>
                </div>
            ...
            <div class="inner-box tab-pane fade active" id="histwo">
                ...
                <div class="accordion-box">
                    ...
                    <div class="accordion accordion-block">
                        <div class="accord-btn"><h4>Working in Remote Environments</h4></div>
                        <div class="accord-content">
                            <p>How all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth.</p>
                        </div>
                    </div>
                    <!--End single accordion box--> 
                    <!--Start single accordion box-->
                    <div class="accordion accordion-block">
                        <div class="accord-btn active"><h4>Minimizing the Harm of Hydrocarbons</h4></div>
                    ...
                    <!--Start single accordion box-->
                    <div class="accordion accordion-block">
                        <div class="accord-btn"><h4>Mineral extraction innovation</h4></div>
                        <div class="accord-content">
                            <p>How all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth.</p>
                        </div>
                    </div>
